...
describe("Briqpay", () => {
  ...
  test("should execute session_complete and make_decision callbacks", async () => {
  ...
  test("session_complete callback triggers submit()", async () => {
  ...
  test("make_decision callback flow works correctly", async () => {
    component.mount("#container");
